...
def debug_logging():
    ...
    logging.getLogger("electrolytedb.data_model").setLevel(logging.DEBUG)
    yield "debug"
    logging.getLogger("electrolytedb.data_model").setLevel(logging.INFO)
...
def test_component_ca_thermo():
    logging.getLogger("idaes.electrolytedb.data_model").setLevel(logging.DEBUG)
    ...
    logging.getLogger("idaes.electrolytedb.data_model").setLevel(logging.INFO)
